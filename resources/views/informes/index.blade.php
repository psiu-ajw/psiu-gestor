                   ...
                   @foreach ($informes as $informe)
                            ...
                            <tr>
                                ...
                                <td class="p-3 flex">
                                    ...
                                    <a @popper(Excluir Informe) href="{{ url('informes', ['destroy',$informe->id])}}" class="btn btn-danger" onclick="return confirm('Você tem certeza que deseja excluir o informe?')"> 
                                        <span>
