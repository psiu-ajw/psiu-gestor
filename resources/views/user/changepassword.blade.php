...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Modificar a sehna') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.changepassword') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="old_password" type="password" class="form-control @error('old_password') inválida @enderror" name="old_password" required autocomplete="old_password">
