...
@extends('layouts.app')
@section('titulo','Lista de Itens Cadastrados')
@section('content')
					...
					@foreach($itens as $item)
						...
						<tr>
							...
							<td>
								...
								<a @popper(Excluir item) onclick="return confirm('Você tem certeza que deseja excluir?')" href="{{ route('delete.item', ['id' => $item->id]) }}" class="btn btn-danger">
